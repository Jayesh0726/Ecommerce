	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">Electro Cart</a>
			</div>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
										<a href="./admin/login.php" style="color:white; text-decoration:none;">Admin Login</a><br><br>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer" style="text-align:center; font-size: 20px; font-weight: bold;">Jayesh Padwal</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
